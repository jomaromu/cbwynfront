...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(usuarioService) {
        ...
        this.treeControl = new tree_1.NestedTreeControl(function (node) { return node.itemsThree; });
        this.dataSource = new tree_2.MatTreeNestedDataSource();
        this.hasChild = function (_, node) { return !!node.itemsThree && node.itemsThree.length > 0; };
    }
    ...
    SidebarComponent.prototype.dataUsuario = function () {
        return __awaiter(this, void 0, Promise, function () {
            var token, usuario, usuarioDB;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        usuario = _a.sent();
                        usuarioDB = usuario.usuarioDBToken.usuarioDB;
    ...
    // SOCKETS
    SidebarComponent.prototype.actualizarPerfil = function () {
        var _this = this;
    ...
    __decorate([
        core_1.Input()
    ], SidebarComponent.prototype, "rutaPrincipal");
    __decorate([
        core_1.Input()
    ], SidebarComponent.prototype, "itemSidebar");
